export default function SchoolLocationContent() {
  return (
    <div className="space-y-8">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">Statement of the Problem</h2>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">Discussion of Findings</h2>
        <p className="text-gray-700 leading-relaxed">
