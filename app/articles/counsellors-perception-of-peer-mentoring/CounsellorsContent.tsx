export default function CounsellorsContent() {
  return (
    <div className="prose max-w-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Online Peer Mentoring</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Statement of the Problem</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Discussion of Findings</h2>
        <p className="mb-4">
