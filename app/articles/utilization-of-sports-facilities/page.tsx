      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <article>
          ...
          <div className="prose max-w-none">
            <SportsFacilitiesUtilizationContent />
          </div>
        </article>
      </div>
    </div>
