...
export default function SocialMediaMentalHealthArticle() {
  const article = {
    ...
    authors: [{ name: "DR. CHINYERE LAMBERT EKEH", affiliation: "Department of Guidance and Counselling, Faculty of Education, Alex Ekwueme Federal University, Ndufu Alike Ikwo, Ebonyi State" }],
